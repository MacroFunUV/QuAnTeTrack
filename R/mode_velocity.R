...
#' @examples
#'
#' # Example 1: Test for Steady, Acceleration, or Deceleration Along Trajectories in MountTom dataset.
#'
...
#'
#' # Example 2: Test for Steady, Acceleration, or Deceleration Along Trajectories in PaluxyRiver dataset.
#'
