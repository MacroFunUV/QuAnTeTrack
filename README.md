...
# Example 1: Paluxy River Dataset - Tracks without missing footprints (Farlow et al., 2011)
...
# Example 2: Mount Tom Dataset - Tracks with missing footprints (Ostrom, 1972)

# Load the TPS file
tpsMountTom <- system.file("extdata", "MountTom.tps", package = "QuAnTeTrack")

# Define missing footprints
NAs <- matrix(c(7, 3), nrow = 1, ncol = 2)

# Convert to a track object with missing footprints specified
