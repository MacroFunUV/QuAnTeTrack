...
For **DTW** (Figure \@ref(dtw_centroid_vs_euclidean_coloured_by_pvalRAW_nsim100)), 
...
For **Fréchet distance** (Figure \@ref(frechet_centroid_vs_euclidean_coloured_by_pvalRAW_nsim100)), 
...
Under the **Higher** hypothesis (Figure \@ref(scatter_angleDelta_vs_euclid_pvalueRAW_ALL_H1-Higher_nsim100)), 
...
Under the **Lower** hypothesis (Figure \@ref(scatter_angleDelta_vs_euclid_pvalueRAW_ALL_H1-Lower_nsim100)), 
...
For the **DTW-based combinations** (Figures \@ref(combined-higher-dtw) and \@ref(combined-lower-dtw))), the overall pattern remains strongly
...
For the **Fréchet-based combinations** (Figures \@ref(combined-higher-frechet) and \@ref(combined-lower-frechet))), the effect of adding
