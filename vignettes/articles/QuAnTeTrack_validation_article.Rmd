...
<div style="text-align: center;">
  <img src="figures/scatter_angleDelta_vs_euclid_pvalueCOMBINED_RAW_Intersection+DTW_Centroid_H1-Higher_nsim100.gif" width="85%" />
  <p><em>Combined significance for Intersection + DTW under the Higher-intersection hypothesis.</em></p>
</div>

<div style="text-align: center;">
  <img src="figures/scatter_angleDelta_vs_euclid_pvalueCOMBINED_RAW_Intersection+DTW_Centroid_H1-Lower_nsim100.gif" width="85%" />
  <p><em>Combined significance for Intersection + DTW under the Lower-intersection hypothesis.</em></p>
</div>
...
<div style="text-align: center;">
  <img src="figures/scatter_angleDelta_vs_euclid_pvalueCOMBINED_RAW_Intersection+Frechet_Centroid_H1-Higher_nsim100.gif" width="85%" />
  <p><em>Combined significance for Intersection + Frechet distance under the Higher-intersection hypothesis.</em></p>
</div>

<div style="text-align: center;">
  <img src="figures/scatter_angleDelta_vs_euclid_pvalueCOMBINED_RAW_Intersection+Frechet_Centroid_H1-Lower_nsim100.gif" width="85%" />
  <p><em>Combined significance for Intersection + Frechet distance under the Lower-intersection hypothesis.</em></p>
</div>
