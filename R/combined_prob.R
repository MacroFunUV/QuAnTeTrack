...
#' DTW2 <- simil_DTW_metric(PaluxyRiver, test = TRUE, H1 = "Lower", sim = s2,
#'   superposition = "None")
#' Frechet2 <- simil_Frechet_metric(PaluxyRiver, test = TRUE, sim = s2,
#'   superposition = "None")
#' int2 <- track_intersection(PaluxyRiver, test = TRUE, sim = s2,
...
#' DTW3 <- simil_DTW_metric(PaluxyRiver, test = TRUE, H1 = "Lower", sim = s3,
#'   superposition = "None")
#' Frechet3 <- simil_Frechet_metric(PaluxyRiver, test = TRUE, sim = s3,
#'   superposition = "None")
#' int3 <- track_intersection(PaluxyRiver, test = TRUE, sim = s3,
...
#' DTW4 <- simil_DTW_metric(sbMountTom, test = TRUE, H1 = "Higher", sim = s4,
#'   superposition = "Centroid")
#' Frechet4 <- simil_Frechet_metric(sbMountTom, test = TRUE, sim = s4,
#'   superposition = "Centroid")
#' int4 <- track_intersection(sbMountTom, test = TRUE, sim = s4,
#'   origin.permutation = "Min.Box")
...
#' DTW5 <- simil_DTW_metric(sbMountTom, test = TRUE, H1 = "Higher", sim = s5,
