...
#' DTW2 <- simil_DTW_metric(PaluxyRiver, test = TRUE, H1 = "Lower",, sim = s2, superposition = "None")
...
#' DTW3 <- simil_DTW_metric(PaluxyRiver, test = TRUE, H1 = "Lower",, sim = s3, superposition = "None")
...
#' DTW4 <- simil_DTW_metric(sbMountTom, test = TRUE, H1 = "Higher",, sim = s4, superposition = "Centroid")
...
#' DTW5 <- simil_DTW_metric(sbMountTom, test = TRUE, H1 = "Higher",, sim = s5, superposition = "Origin")
