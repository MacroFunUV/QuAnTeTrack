...
difference.](figures/scatter_angleDelta_vs_euclid_pvalueRAW_ALL_H1-Higher_nsim100.png){fig-align="center"
width="70%"}
...
against initial Euclidean spacing and angular
difference.](figures/scatter_angleDelta_vs_euclid_pvalueRAW_ALL_H1-Lower_nsim100.png){fig-align="center"
width="70%"}
...
Higher-intersection
hypothesis.](figures/scatter_angleDelta_vs_euclid_pvalueCOMBINED_RAW_Intersection+DTW_Centroid_H1-Higher_nsim100.png){width="100%"}
...
![Combined significance for Intersection + DTW under the
Lower-intersection
hypothesis.](figures/scatter_angleDelta_vs_euclid_pvalueCOMBINED_RAW_Intersection+DTW_Centroid_H1-Lower_nsim100.png){width="100%"}
