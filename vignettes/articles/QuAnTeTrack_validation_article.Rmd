...
For **DTW** (Figure \@ref(fig:dtw_centroid_vs_euclidean_coloured_by_pvalRAW_nsim100)), 
...
For **Fréchet distance** (Figure \@ref(fig:frechet_centroid_vs_euclidean_coloured_by_pvalRAW_nsim100)), 
...
Under the **Higher** hypothesis (Figure \@ref(fig:scatter_angleDelta_vs_euclid_pvalueRAW_ALL_H1-Higher_nsim100)), 
...
```{r scatter_angleDelta_vs_euclid_pvalueRAW_ALL_H1-Higher_nsim100, echo=FALSE, out.width="85%", fig.align="center", fig.cap="Pairwise significance for the Higher-intersection hypothesis plotted against initial Euclidean spacing and angular difference."}
knitr::include_graphics("figures/scatter_angleDelta_vs_euclid_pvalueRAW_ALL_H1-Higher_nsim100.png")
```

Under the **Lower** hypothesis (Figure \@ref(fig:scatter_angleDelta_vs_euclid_pvalueRAW_ALL_H1-Lower_nsim100)), 
...
```{r scatter_angleDelta_vs_euclid_pvalueRAW_ALL_H1-Lower_nsim100, echo=FALSE, out.width="85%", fig.align="center", fig.cap="Pairwise significance for the Lower-intersection hypothesis plotted against initial Euclidean spacing and angular difference."}
...
For the **DTW-based combinations** (Figures \@ref(fig:combined-higher-dtw) and \@ref(fig:combined-lower-dtw))), the overall pattern remains strongly
...
![Combined significance for Intersection + DTW under the Higher-intersection hypothesis.](figures/scatter_angleDelta_vs_euclid_pvalueCOMBINED_RAW_Intersection+DTW_Centroid_H1-Higher_nsim100.gif){#fig:combined-higher-dtw width=85%}
![Combined significance for Intersection + DTW under the Lower-intersection hypothesis.](figures/scatter_angleDelta_vs_euclid_pvalueCOMBINED_RAW_Intersection+DTW_Centroid_H1-Lower_nsim100.gif){#fig:combined-lower-dtw width=85%}


For the **Fréchet-based combinations** (Figures \@ref(fig:combined-higher-frechet) and \@ref(fig:combined-lower-frechet))), the effect of adding
...
![Combined significance for Intersection + Frechet distance under the Higher-intersection hypothesis.](figures/scatter_angleDelta_vs_euclid_pvalueCOMBINED_RAW_Intersection+Frechet_Centroid_H1-Higher_nsim100.gif){#fig:combined-higher-frechet width=85%}

![Combined significance for Intersection + Frechet distance under the Lower-intersection hypothesis.](figures/scatter_angleDelta_vs_euclid_pvalueCOMBINED_RAW_Intersection+Frechet_Centroid_H1-Lower_nsim100.gif){#fig:combined-lower-frechet width=85%}
