...
(`simil_Frechet_metric()`). Both metrics quantify the extent to which
individual movement paths resemble one another, but they emphasize
different properties of trajectory geometry. DTW is more tolerant of
local differences in pace or temporal alignment, whereas Fréchet
distance is more sensitive to the overall geometric similarity of the
paths.
